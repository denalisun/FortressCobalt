...
public:
	...
	uint8                                         Pad_3663[0x4];                                     // 0x0ACC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGAB_AthenaDBNO_C) == 0x000BA0, "Wrong size on UGAB_AthenaDBNO_C");
...
static_assert(offsetof(UGAB_AthenaDBNO_C, DBNOBleedGEHandle) == 0x000B98, "Member 'UGAB_AthenaDBNO_C::DBNOBleedGEHandle' has a wrong offset!");
