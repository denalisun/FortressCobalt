...
public:
	...
	class UImage*                                 ImageEmptySpot;                                    // 0x0220(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOverlay*                               OverlayEmptySlot;                                  // 0x0228(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOverlay*                               OverlayInputAction;                                // 0x0230(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	int32                                         PlayerID;                                          // 0x0238(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ULobbyPlayerAddPlayer_C) == 0x000240, "Wrong size on ULobbyPlayerAddPlayer_C");
...
static_assert(offsetof(ULobbyPlayerAddPlayer_C, ImageEmptySpot) == 0x000220, "Member 'ULobbyPlayerAddPlayer_C::ImageEmptySpot' has a wrong offset!");
static_assert(offsetof(ULobbyPlayerAddPlayer_C, OverlayEmptySlot) == 0x000228, "Member 'ULobbyPlayerAddPlayer_C::OverlayEmptySlot' has a wrong offset!");
static_assert(offsetof(ULobbyPlayerAddPlayer_C, OverlayInputAction) == 0x000230, "Member 'ULobbyPlayerAddPlayer_C::OverlayInputAction' has a wrong offset!");
static_assert(offsetof(ULobbyPlayerAddPlayer_C, PlayerID) == 0x000238, "Member 'ULobbyPlayerAddPlayer_C::PlayerID' has a wrong offset!");
