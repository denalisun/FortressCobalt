...
void UResolutionScaleSlider_C::Update_Slider(const class FText& Slider_Text, const class FText& Param_Hover_Text, class UCommonTextBlock* Tooltip_Text_Block)
{
	static class UFunction* Func = nullptr;
