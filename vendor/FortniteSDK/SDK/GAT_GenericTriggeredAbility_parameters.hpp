...
public:
	...
	uint8                                         Pad_4201[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FGameplayEventData                     K2Node_Event_EventData;                            // 0x0130(0x00A8)()
};
...
static_assert(offsetof(GAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent, Param_EventData) == 0x000000, "Member 'GAT_GenericTriggeredAbility_C_K2_ActivateAbilityFromEvent::Param_EventData' has a wrong offset!");
