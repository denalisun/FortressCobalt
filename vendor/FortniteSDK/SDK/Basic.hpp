...
namespace Offsets
{
	constexpr int32 GObjects          = 0x044E5CE0;
	constexpr int32 AppendString      = 0x00C63FD0;
	constexpr int32 GNames            = 0x044DC610;
	constexpr int32 GWorld            = 0x045CD788;
	constexpr int32 ProcessEvent      = 0x00DF9B40;
