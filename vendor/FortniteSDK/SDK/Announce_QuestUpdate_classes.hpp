...
public:
	...
	struct FDynamicQuestUpdateInfo                QuestUpdateInfo;                                   // 0x03E0(0x0020)(Edit, BlueprintVisible, Net, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(AAnnounce_QuestUpdate_C) == 0x000400, "Wrong size on AAnnounce_QuestUpdate_C");
static_assert(offsetof(AAnnounce_QuestUpdate_C, DefaultSceneRoot) == 0x0003D8, "Member 'AAnnounce_QuestUpdate_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AAnnounce_QuestUpdate_C, QuestUpdateInfo) == 0x0003E0, "Member 'AAnnounce_QuestUpdate_C::QuestUpdateInfo' has a wrong offset!");
