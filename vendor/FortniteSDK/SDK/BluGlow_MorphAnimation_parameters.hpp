...
public:
	...
	uint8                                         Pad_2389[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_K2_AddLocalRotation_SweepHitResult;       // 0x0050(0x0080)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
static_assert(offsetof(BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation, CallFunc_Percent_IntInt_ReturnValue) == 0x0000D0, "Member 'BluGlow_MorphAnimation_C_ExecuteUbergraph_BluGlow_MorphAnimation::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
