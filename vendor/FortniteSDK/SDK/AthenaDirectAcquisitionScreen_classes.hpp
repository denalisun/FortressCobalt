...
public:
	...
	struct FTimerHandle                           CycleTimer;                                        // 0x04B0(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	TArray<class UAthenaDirectAcquisitionOfferWidget_C*> CycledOffersWidgets;                               // 0x04B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FTimerHandle                           NewVar_0;                                          // 0x04C8(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	TMap<class FString, class UAthenaDirectAcquisitionOfferWidget_C*> CategorizedOfferWidgets;                           // 0x04D0(0x0050)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int32                                         TestVar;                                           // 0x0520(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UAthenaDirectAcquisitionScreen_C) == 0x000528, "Wrong size on UAthenaDirectAcquisitionScreen_C");
...
static_assert(offsetof(UAthenaDirectAcquisitionScreen_C, CycleTimer) == 0x0004B0, "Member 'UAthenaDirectAcquisitionScreen_C::CycleTimer' has a wrong offset!");
static_assert(offsetof(UAthenaDirectAcquisitionScreen_C, CycledOffersWidgets) == 0x0004B8, "Member 'UAthenaDirectAcquisitionScreen_C::CycledOffersWidgets' has a wrong offset!");
static_assert(offsetof(UAthenaDirectAcquisitionScreen_C, NewVar_0) == 0x0004C8, "Member 'UAthenaDirectAcquisitionScreen_C::NewVar_0' has a wrong offset!");
static_assert(offsetof(UAthenaDirectAcquisitionScreen_C, CategorizedOfferWidgets) == 0x0004D0, "Member 'UAthenaDirectAcquisitionScreen_C::CategorizedOfferWidgets' has a wrong offset!");
static_assert(offsetof(UAthenaDirectAcquisitionScreen_C, TestVar) == 0x000520, "Member 'UAthenaDirectAcquisitionScreen_C::TestVar' has a wrong offset!");
