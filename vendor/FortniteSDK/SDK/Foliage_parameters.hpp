...
public:
	...
	uint8                                         Pad_1A64[0x4];                                     // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1A76[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             OverlapInfo;                                       // 0x0020(0x0080)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(InteractiveFoliageActor_CapsuleTouched) == 0x0000A0, "Wrong size on InteractiveFoliageActor_CapsuleTouched");
