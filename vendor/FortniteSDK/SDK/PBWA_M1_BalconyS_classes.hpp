...
{
public:
	uint8                                         Pad_4040[0x8];                                     // 0x0E08(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APBWA_M1_BalconyS_C) == 0x000E10, "Wrong size on APBWA_M1_BalconyS_C");
