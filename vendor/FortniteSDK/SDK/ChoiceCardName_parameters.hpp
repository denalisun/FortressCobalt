...
public:
	...
	uint8                                         Pad_27EC[0x6];                                     // 0x001A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(ChoiceCardName_C_UpdateText, Param_DisplayText) == 0x000000, "Member 'ChoiceCardName_C_UpdateText::Param_DisplayText' has a wrong offset!");
