...
struct FEventReply UOptionsMenuSetting_C::OnFocusReceived(const struct FGeometry& MyGeometry, const struct FFocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("OptionsMenuSetting_C", "OnFocusReceived");

	Params::OptionsMenuSetting_C_OnFocusReceived Parms{};
