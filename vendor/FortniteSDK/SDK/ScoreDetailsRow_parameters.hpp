...
public:
	...
	uint8                                         Pad_3A96[0x1];                                     // 0x002B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A97[0x3];                                     // 0x0039(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, Param_PlayerName) == 0x000000, "Member 'ScoreDetailsRow_C_UpdateRow::Param_PlayerName' has a wrong offset!");
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, Param_TotalScore) == 0x000018, "Member 'ScoreDetailsRow_C_UpdateRow::Param_TotalScore' has a wrong offset!");
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, Param_Combat) == 0x00001C, "Member 'ScoreDetailsRow_C_UpdateRow::Param_Combat' has a wrong offset!");
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, Param_Building) == 0x000020, "Member 'ScoreDetailsRow_C_UpdateRow::Param_Building' has a wrong offset!");
static_assert(offsetof(ScoreDetailsRow_C_UpdateRow, Param_Utility) == 0x000024, "Member 'ScoreDetailsRow_C_UpdateRow::Param_Utility' has a wrong offset!");
