...
{
public:
	uint8                                         Pad_21FD[0x68];                                    // 0x0418(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_21FE[0x10];                                    // 0x0390(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AQosBeaconHost) == 0x0003A0, "Wrong size on AQosBeaconHost");
...
public:
	...
	uint8                                         Pad_21FF[0xA8];                                    // 0x0030(0x00A8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2200[0x2];                                     // 0x00DE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FQosRegionInfo>                 Datacenters;                                       // 0x00E0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2201[0x30];                                    // 0x00F0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2202[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2203[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2204[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2205[0x7];                                     // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 SelectedRegionId;                                  // 0x0088(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2206[0x10];                                    // 0x0098(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
