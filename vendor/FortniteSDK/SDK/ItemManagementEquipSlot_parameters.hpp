...
public:
	...
	uint8                                         Pad_38F7[0x2];                                     // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FPointerEvent                          K2Node_Event_PointerEvent;                         // 0x0020(0x0068)()
	...
	uint8                                         Pad_38F9[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UItemManagementInventoryPanel_C*        K2Node_DynamicCast_AsItem_Management_Inventory_Panel; // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                         Pad_38FB[0x7];                                     // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_38FC[0x7];                                     // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ItemManagementEquipSlot_C_OnDrop) == 0x0000E0, "Wrong size on ItemManagementEquipSlot_C_OnDrop");
...
static_assert(offsetof(ItemManagementEquipSlot_C_OnDrop, K2Node_DynamicCast_AsFort_Item) == 0x0000B0, "Member 'ItemManagementEquipSlot_C_OnDrop::K2Node_DynamicCast_AsFort_Item' has a wrong offset!");
...
static_assert(offsetof(ItemManagementEquipSlot_C_OnDrop, K2Node_DynamicCast_AsItem_Management_Inventory_Panel) == 0x0000C0, "Member 'ItemManagementEquipSlot_C_OnDrop::K2Node_DynamicCast_AsItem_Management_Inventory_Panel' has a wrong offset!");
static_assert(offsetof(ItemManagementEquipSlot_C_OnDrop, K2Node_DynamicCast_bSuccess2) == 0x0000C8, "Member 'ItemManagementEquipSlot_C_OnDrop::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
static_assert(offsetof(ItemManagementEquipSlot_C_OnDrop, CallFunc_GetContext_ReturnValue) == 0x0000D0, "Member 'ItemManagementEquipSlot_C_OnDrop::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemManagementEquipSlot_C_OnDrop, CallFunc_DropItemOnQuickBar_ReturnValue) == 0x0000D8, "Member 'ItemManagementEquipSlot_C_OnDrop::CallFunc_DropItemOnQuickBar_ReturnValue' has a wrong offset!");
...
public:
	...
	class UFortGlobalUIContext*                   CallFunc_GetContext_ReturnValue;                   // 0x02C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortItem*                              CallFunc_GetItemToDetail_ReturnValue;              // 0x02D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ItemManagementEquipSlot_C_OnMouseButtonDown) == 0x0002E0, "Wrong size on ItemManagementEquipSlot_C_OnMouseButtonDown");
...
static_assert(offsetof(ItemManagementEquipSlot_C_OnMouseButtonDown, CallFunc_Handled_ReturnValue) == 0x000158, "Member 'ItemManagementEquipSlot_C_OnMouseButtonDown::CallFunc_Handled_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemManagementEquipSlot_C_OnMouseButtonDown, CallFunc_GetContext_ReturnValue) == 0x0002C8, "Member 'ItemManagementEquipSlot_C_OnMouseButtonDown::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemManagementEquipSlot_C_OnMouseButtonDown, CallFunc_GetItemToDetail_ReturnValue) == 0x0002D0, "Member 'ItemManagementEquipSlot_C_OnMouseButtonDown::CallFunc_GetItemToDetail_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemManagementEquipSlot_C_OnMouseButtonDown, CallFunc_IsUsingGamepad_ReturnValue) == 0x0002D8, "Member 'ItemManagementEquipSlot_C_OnMouseButtonDown::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_38FD[0x6];                                     // 0x00BA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_38FE[0x7];                                     // 0x0101(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UItemDragIcon_C*                        CallFunc_Create_ReturnValue;                       // 0x0108(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ItemManagementEquipSlot_C_OnDragDetected, K2Node_DynamicCast_bSuccess2) == 0x000100, "Member 'ItemManagementEquipSlot_C_OnDragDetected::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
