...
public:
	...
	ESlateVisibility                              Temp_byte_Variable2;                               // 0x01F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              Temp_byte_Variable4;                               // 0x01FC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable2;                               // 0x01FD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2B5A[0x2];                                     // 0x01FE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          Temp_bool_Variable3;                               // 0x0209(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2B5B[0x6];                                     // 0x020A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          CallFunc_IsInLocalPlayersParty_ReturnValue;        // 0x022A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2B5C[0x5];                                     // 0x022B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	ESlateVisibility                              K2Node_Select3_Default;                            // 0x0261(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_IntInt_ReturnValue;               // 0x0262(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2B5D[0x1];                                     // 0x0263(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         K2Node_Select4_Default;                            // 0x0264(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x0268(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue2;                  // 0x0269(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              K2Node_Select5_Default;                            // 0x026A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, Temp_byte_Variable2) == 0x0001F9, "Member 'HUDMinusTeamMemberInfo_C_Update::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, Temp_bool_Variable) == 0x0001FA, "Member 'HUDMinusTeamMemberInfo_C_Update::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, Temp_byte_Variable4) == 0x0001FC, "Member 'HUDMinusTeamMemberInfo_C_Update::Temp_byte_Variable4' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, Temp_bool_Variable2) == 0x0001FD, "Member 'HUDMinusTeamMemberInfo_C_Update::Temp_bool_Variable2' has a wrong offset!");
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, CallFunc_IsValid_UniqueNetIdRepl_ReturnValue) == 0x000208, "Member 'HUDMinusTeamMemberInfo_C_Update::CallFunc_IsValid_UniqueNetIdRepl_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, Temp_bool_Variable3) == 0x000209, "Member 'HUDMinusTeamMemberInfo_C_Update::Temp_bool_Variable3' has a wrong offset!");
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, Temp_bool_Variable4) == 0x000228, "Member 'HUDMinusTeamMemberInfo_C_Update::Temp_bool_Variable4' has a wrong offset!");
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, CallFunc_IsInLocalPlayersParty_ReturnValue) == 0x00022A, "Member 'HUDMinusTeamMemberInfo_C_Update::CallFunc_IsInLocalPlayersParty_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, CallFunc_IsValid_ReturnValue) == 0x000260, "Member 'HUDMinusTeamMemberInfo_C_Update::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, K2Node_Select3_Default) == 0x000261, "Member 'HUDMinusTeamMemberInfo_C_Update::K2Node_Select3_Default' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, CallFunc_Greater_IntInt_ReturnValue) == 0x000262, "Member 'HUDMinusTeamMemberInfo_C_Update::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, K2Node_Select4_Default) == 0x000264, "Member 'HUDMinusTeamMemberInfo_C_Update::K2Node_Select4_Default' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, CallFunc_BooleanAND_ReturnValue) == 0x000268, "Member 'HUDMinusTeamMemberInfo_C_Update::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, CallFunc_BooleanAND_ReturnValue2) == 0x000269, "Member 'HUDMinusTeamMemberInfo_C_Update::CallFunc_BooleanAND_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUDMinusTeamMemberInfo_C_Update, K2Node_Select5_Default) == 0x00026A, "Member 'HUDMinusTeamMemberInfo_C_Update::K2Node_Select5_Default' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2B5E[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
