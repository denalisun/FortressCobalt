...
void UOptionsMenuSlider_C::Update_Slider(const class FText& Slider_Text, float Slider_Value, const class FText& Param_Hover_Text, class UCommonTextBlock* Tooltip_Text_Block)
{
	static class UFunction* Func = nullptr;
...
struct FEventReply UOptionsMenuSlider_C::OnFocusReceived(const struct FGeometry& MyGeometry, const struct FFocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;
