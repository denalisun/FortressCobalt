...
public:
	...
	uint8                                         Pad_33EB[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	int32                                         CallFunc_Add_IntInt_ReturnValue5;                  // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Conv_IntToFloat_ReturnValue3;             // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Lerp_ReturnValue2;                        // 0x0044(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_FTrunc_ReturnValue2;                      // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Conv_IntToFloat_ReturnValue4;             // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue2) == 0x00001C, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue3) == 0x000020, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue3' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue4) == 0x000024, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue4' has a wrong offset!");
...
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Add_IntInt_ReturnValue5) == 0x00002C, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Add_IntInt_ReturnValue5' has a wrong offset!");
...
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Conv_IntToFloat_ReturnValue2) == 0x000034, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Conv_IntToFloat_ReturnValue2' has a wrong offset!");
...
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Conv_IntToFloat_ReturnValue3) == 0x000040, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Conv_IntToFloat_ReturnValue3' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Lerp_ReturnValue2) == 0x000044, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Lerp_ReturnValue2' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_FTrunc_ReturnValue2) == 0x000048, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_FTrunc_ReturnValue2' has a wrong offset!");
static_assert(offsetof(TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP, CallFunc_Conv_IntToFloat_ReturnValue4) == 0x00004C, "Member 'TeamScoreToPlayerXPRewardWidget_C_Update_XP_LERP::CallFunc_Conv_IntToFloat_ReturnValue4' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_33EC[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
