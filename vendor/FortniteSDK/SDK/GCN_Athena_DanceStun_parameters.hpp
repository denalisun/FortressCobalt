...
public:
	...
	struct FVector                                CallFunc_Conv_FloatToVector_ReturnValue2;          // 0x0010(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             CallFunc_K2_AddLocalRotation_SweepHitResult;       // 0x0030(0x0080)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
static_assert(sizeof(GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun) == 0x0000B0, "Wrong size on GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun");
...
static_assert(offsetof(GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun, CallFunc_Conv_FloatToVector_ReturnValue2) == 0x000010, "Member 'GCN_Athena_DanceStun_C_ExecuteUbergraph_GCN_Athena_DanceStun::CallFunc_Conv_FloatToVector_ReturnValue2' has a wrong offset!");
...
public:
	...
	struct FGameplayCueParameters                 Parameters;                                        // 0x0008(0x00B8)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	bool                                          ReturnValue;                                       // 0x00C0(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1AB2[0x7];                                     // 0x00C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
