...
// Parameters:
// EFortLoginAccountType                   Platform                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ULoginScreen_C::HandleEpicAccountForward(EFortLoginAccountType Platform)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "HandleEpicAccountForward");

	Params::LoginScreen_C_HandleEpicAccountForward Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortLoginAccountType                   ChosenCredential                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ULoginScreen_C::HandleCredentialSelected(EFortLoginAccountType ChosenCredential)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "HandleCredentialSelected");

	Params::LoginScreen_C_HandleCredentialSelected Parms{};

	Parms.ChosenCredential = ChosenCredential;
...
void ULoginScreen_C::HandleNewAccountCreation()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "HandleNewAccountCreation");
...
void ULoginScreen_C::HandleEpicAccountSelected()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "HandleEpicAccountSelected");
...
void ULoginScreen_C::TempBackEvent(class UCommonButton* Button)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "TempBackEvent");

	Params::LoginScreen_C_TempBackEvent Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    PlayedBefore                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void ULoginScreen_C::HandlePlayedBeforeSelected(bool PlayedBefore)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "HandlePlayedBeforeSelected");

	Params::LoginScreen_C_HandlePlayedBeforeSelected Parms{};

	Parms.PlayedBefore = PlayedBefore;
...
// EExternalAccountType                    Account_Type                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ULoginScreen_C::HandleOnStartLogin(const class FString& LoginEmail, const class FString& LoginPassword, EExternalAccountType Account_Type)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Account_Type = Account_Type;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWidget*                          NativeWidget                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ULoginScreen_C::ShowPlayedBeforeSelect()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "ShowPlayedBeforeSelect");
...
void ULoginScreen_C::ShowLoginCredentialSelect()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "ShowLoginCredentialSelect");
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortLoginAccountType                   LoginType                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ULoginScreen_C::ShowRedirectToEpicAccount(EFortLoginAccountType LoginType)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "ShowRedirectToEpicAccount");

	Params::LoginScreen_C_ShowRedirectToEpicAccount Parms{};
...
void ULoginScreen_C::ShowNewAccountWarningModal(class UCommonButton* Button)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("LoginScreen_C", "ShowNewAccountWarningModal");

	Params::LoginScreen_C_ShowNewAccountWarningModal Parms{};
