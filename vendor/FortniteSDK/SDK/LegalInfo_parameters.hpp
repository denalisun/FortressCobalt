...
public:
	...
	uint8                                         Pad_37CB[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UWidget*                                K2Node_ComponentBoundEvent_ActiveWidget;           // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UEulaTab_C*                             K2Node_DynamicCast_AsEula_Tab;                     // 0x0040(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_37CD[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_37CE[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UThirdPartyTab_C*                       K2Node_DynamicCast_AsThird_Party_Tab;              // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess3;                      // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_37CF[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(LegalInfo_C_ExecuteUbergraph_LegalInfo, K2Node_DynamicCast_bSuccess2) == 0x000058, "Member 'LegalInfo_C_ExecuteUbergraph_LegalInfo::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
