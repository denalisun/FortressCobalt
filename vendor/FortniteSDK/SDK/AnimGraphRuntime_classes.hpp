...
{
public:
	uint8                                         Pad_1B92[0x8];                                     // 0x03C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAnimCustomInstance) == 0x0003D0, "Wrong size on UAnimCustomInstance");
...
static_assert(sizeof(UAnimSequencerInstance) == 0x0003D0, "Wrong size on UAnimSequencerInstance");
...
public:
	...
	uint8                                         Pad_1B96[0x98];                                    // 0x0078(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
