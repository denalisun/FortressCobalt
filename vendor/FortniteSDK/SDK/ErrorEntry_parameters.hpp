...
public:
	...
	uint8                                         Pad_24DE[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_24DF[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FFortErrorInfo                         Param_ErrorInfo;                                   // 0x0000(0x0080)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(offsetof(ErrorEntry_C_SetErrorInfo, Param_ErrorInfo) == 0x000000, "Member 'ErrorEntry_C_SetErrorInfo::Param_ErrorInfo' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_24E0[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
