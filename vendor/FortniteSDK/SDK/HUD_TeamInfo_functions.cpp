...
void UHUD_TeamInfo_C::ShiftTeamMembers(struct FFortTeamMemberInfo& TeamMemberInfo, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct FFortTeamMemberInfo              TeamMemberInfo                                         (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// int32                                   TeamMemberNumber                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHUD_TeamInfo_C::AppendTeamMember(struct FFortTeamMemberInfo& TeamMemberInfo, int32 TeamMemberNumber)
{
	static class UFunction* Func = nullptr;
	...
	Parms.TeamMemberInfo = std::move(TeamMemberInfo);
	Parms.TeamMemberNumber = TeamMemberNumber;
