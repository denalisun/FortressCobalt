...
void UAthenaLobby_C::OnUpdateSocialImportButtonText(const class FText& NewText)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaLobby_C", "OnUpdateSocialImportButtonText");

	Params::AthenaLobby_C_OnUpdateSocialImportButtonText Parms{};
