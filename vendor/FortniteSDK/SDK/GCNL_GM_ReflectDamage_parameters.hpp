...
public:
	...
	uint8                                         Pad_2D94[0x4];                                     // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2D95[0x4];                                     // 0x00E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x0138(0x0080)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                                CallFunc_GetSocketLocation_ReturnValue2;           // 0x01BC(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Subtract_VectorVector_ReturnValue2;       // 0x01C8(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_MakeVector_ReturnValue;                   // 0x01D4(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_RandomUnitVector_ReturnValue;             // 0x01E0(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Multiply_VectorVector_ReturnValue;        // 0x01EC(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Add_VectorVector_ReturnValue;             // 0x01F8(0x000C)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2D96[0x4];                                     // 0x0204(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult;    // 0x0208(0x0080)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
static_assert(sizeof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned) == 0x000288, "Wrong size on GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned");
...
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_Divide_FloatFloat_ReturnValue) == 0x0001B8, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_GetSocketLocation_ReturnValue2) == 0x0001BC, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_GetSocketLocation_ReturnValue2' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_Subtract_VectorVector_ReturnValue2) == 0x0001C8, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_Subtract_VectorVector_ReturnValue2' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_MakeVector_ReturnValue) == 0x0001D4, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_RandomUnitVector_ReturnValue) == 0x0001E0, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_RandomUnitVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_Multiply_VectorVector_ReturnValue) == 0x0001EC, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_Multiply_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_Add_VectorVector_ReturnValue) == 0x0001F8, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x000208, "Member 'GCNL_GM_ReflectDamage_C_OnStartParticleSystemSpawned::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
