...
public:
	...
	uint8                                         Pad_2FCF[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2FD0[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, CallFunc_Array_Get_Item2) == 0x000028, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::CallFunc_Array_Get_Item2' has a wrong offset!");
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000040, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, CallFunc_Array_Length_ReturnValue) == 0x000044, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(AthenaKillFeedWidget_C_UpdateKillFeed, CallFunc_Less_IntInt_ReturnValue) == 0x000048, "Member 'AthenaKillFeedWidget_C_UpdateKillFeed::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
