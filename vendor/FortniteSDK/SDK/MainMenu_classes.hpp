...
public:
	...
	class UIconTextButton_C*                      TestUIButton;                                      // 0x0328(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UMessageCenterWidget_C*                 MessageCenter;                                     // 0x0330(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UOptionsMenu_C*                         OptionsMenu;                                       // 0x0338(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	UMulticastDelegateProperty_                   OnRequestShowFeedbackWidget;                       // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class ULegalInfo_C*                           Legal_Widget;                                      // 0x0350(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortQuestItemDefinition*               OnboardingQuest;                                   // 0x0358(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          TutorialComplete_;                                 // 0x0360(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_3857[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UQuestScreen_C*                         QuestScreen;                                       // 0x0368(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCredits_C*                             CreditsWidget;                                     // 0x0370(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPermissionsRoot_C*                     StormShieldPermissions;                            // 0x0378(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UNews_C*                                NewsWidget;                                        // 0x0380(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UShowFriendCodesSelection_C*            FriendCodesSelectionWindow;                        // 0x0388(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPrivacyWidget_C*                       PrivacyWidget;                                     // 0x0390(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPartyFinder_C*                         PartyFinder;                                       // 0x0398(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_3858[0x7];                                     // 0x03D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UChangeSubgameButton_C*                 ChangeSubgameButton_0;                             // 0x03F0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UMainMenu_C) == 0x000408, "Wrong size on UMainMenu_C");
...
static_assert(offsetof(UMainMenu_C, TestUIButton) == 0x000328, "Member 'UMainMenu_C::TestUIButton' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, MessageCenter) == 0x000330, "Member 'UMainMenu_C::MessageCenter' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, OptionsMenu) == 0x000338, "Member 'UMainMenu_C::OptionsMenu' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, OnRequestShowFeedbackWidget) == 0x000340, "Member 'UMainMenu_C::OnRequestShowFeedbackWidget' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, Legal_Widget) == 0x000350, "Member 'UMainMenu_C::Legal_Widget' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, OnboardingQuest) == 0x000358, "Member 'UMainMenu_C::OnboardingQuest' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, TutorialComplete_) == 0x000360, "Member 'UMainMenu_C::TutorialComplete_' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, QuestScreen) == 0x000368, "Member 'UMainMenu_C::QuestScreen' has a wrong offset!");
static_assert(offsetof(UMainMenu_C, CreditsWidget) == 0x000370, "Member 'UMainMenu_C::CreditsWidget' has a wrong offset!");
