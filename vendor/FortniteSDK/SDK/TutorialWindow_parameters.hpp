...
static_assert(offsetof(TutorialWindow_C_SetDescription, Param_Description) == 0x000000, "Member 'TutorialWindow_C_SetDescription::Param_Description' has a wrong offset!");
